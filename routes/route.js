...
const orders2025=require("../models/orders2025");
const orders2026=require("../models/orders2026");
...
console.log(t1)
 let neworder=new orders2026(t1)   //let neworder=new orders2023(t1)  2024 updated *********************
...
//     })
  ...
  //// else if  2023 updated *********************
    ...
    else if(req.params.orderscehma=="orders2025"){
      orders2025.find((err,data)=>{
        res.json(data.reverse());
      })
    } 
    else if(req.params.orderscehma=="orders2026"){
      orders2026.find((err,data)=>{
        res.json(data.reverse());
      })
    }   
...
router.put("/editplacedorderbuyer/:id/:orderscehma",(req,res)=>{
  ...
  var newvalues = { $set: {username: req.body.username,shipping: req.body.shipping,phone: req.body.phone,location: req.body.location,sellerdiscount: req.body.sellerdiscount,comment: req.body.comment,deliverycharge:req.body.deliverycharge,llr:req.body.llr,buyergstamount:req.body.buyergstamount,sellergstamount:req.body.sellergstamount} };
  ord.updateOne(myquery, newvalues,(err,result)=>{
    if(err){
...
// router.get("/pusheditbrand",(req,res)=>{
//      var newvalues = { $set:{ "deliverycharge":0}};
//      orders2024.updateMany({deliverycharge:null}, newvalues,(err,result)=>{
//         if(err){
//           console.log(result)
//             res.json({result});
...
// router.get("/pusheditbrand1",(req,res)=>{
//      var newvalues = { $set:{ "llr":"","buyergstamount":0,"sellergstamount":0}};
//      orders2024.updateMany({}, newvalues,(err,result)=>{
//         if(err){
//           console.log(result)
//             res.json({result});
